...
strategy4(I,J):-
    ...
    J1 is J + 1,
    J2 is J - 1,
    (return_color(I1,J,Co),Co \= 'blue' , asserta(solve_cell(I1,J,'blue')));
    (return_color(I2,J,Co),Co \= 'blue' , asserta(solve_cell(I2,J,'blue')));
    (return_color(I,J1,Co),Co \= 'blue' , asserta(solve_cell(I,J1,'blue')));
    (return_color(I,J2,Co),Co \= 'blue' , asserta(solve_cell(I1,J,'blue'))).
